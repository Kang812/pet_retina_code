...
## Cat
image_paths = glob("/mnt/d/project/pet_retina/data/images/cat/*/*/*.jpg") + glob("/mnt/d/project/pet_retina/data/images/cat/*/*/*.png")
...
df.to_csv("/mnt/d/project/pet_retina/data/cat_full_dataframe.csv", index = False)
